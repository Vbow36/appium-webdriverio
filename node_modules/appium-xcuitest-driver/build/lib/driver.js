...
class XCUITestDriver extends driver_1.BaseDriver {
    ...
    async start() {
        ...
        if (this.opts.app) {
            ...
            if (!this.opts.bundleId) {
                this.opts.bundleId = await (0, app_utils_1.extractBundleId)(this.opts.app);
            }
        }
        await this.runReset();
    ...
    async startWda(sessionId, realDevice) {
        ...
        return await SHARED_RESOURCES_GUARD.acquire(synchronizationKey, async () => {
            ...
            const quitAndUninstall = async (msg) => {
                ...
                if (noUninstallCap) {
                    this.log.debug(`Not quitting/uninstalling WebDriverAgent since ${noUninstallCap} capability is provided`);
                    throw new Error(msg);
                }
                ...
                try {
                    if (this.opts.usePreinstalledWDA) {
                        ...
                        if (this.opts.prebuiltWDAPath) {
                            const candidateBundleId = await (0, app_utils_1.extractBundleId)(this.opts.prebuiltWDAPath);
    ...
    async checkAutInstallationState(opts) {
        ...
        const candidateBundleVersion = await (0, app_utils_1.extractBundleVersion)(app);
    ...
    async installAUT() {
        ...
        await (0, app_utils_1.verifyApplicationPlatform)(this.opts.app, {
