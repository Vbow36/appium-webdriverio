...
export class XCUITestDriver extends BaseDriver<{
    ...
    readonly resultBundleVersion: {
        readonly isNumber: true; /** @type {string|null|undefined} */
    };
    ...
    static executeMethodMap: {
        ...
        readonly 'mobile: installApp': {
            ...
            readonly params: {
                ...
                readonly optional: readonly ["strategy", "timeoutMs", "checkVersion"];
            };
        };
        ...
        readonly 'mobile: installCertificate': {
            readonly command: "mobileInstallCertificate"; /** @type {((logRecord: {message: string}) => void)|null} */
            readonly params: {
                readonly required: readonly ["content"];
    ...
    mobileInstallApp: (this: XCUITestDriver, app: string, timeoutMs?: number | undefined, strategy?: import("./commands/types").AppInstallStrategy | undefined, checkVersion?: boolean | undefined) => Promise<void>;
